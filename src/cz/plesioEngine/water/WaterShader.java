...
public class WaterShader extends ShaderProgram {
    ...
    private final static String VERTEX_FILE = "src/cz/plesioEngine/water/waterVertex.glsl";
    private final static String FRAGMENT_FILE = "src/cz/plesioEngine/water/waterFragment.glsl";
