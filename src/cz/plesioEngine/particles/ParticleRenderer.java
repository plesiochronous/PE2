...
public class ParticleRenderer {
    ...
    protected ParticleRenderer(Loader loader, Matrix4f projectionMatrix) {
        _loader = loader;
        this.vbo = _loader.createEmptyVBO(INSTANCE_DATA_LENGTH * MAX_INSTANCES);
        quad = _loader.loadToVAO(VERTICES, 2);
        loadInstancedAttributes(loader);
    ...
    private void loadInstancedAttributes(Loader loader) {
        loader.addInstancedAtrribute(quad.getVaoID(), vbo, 1, 4, INSTANCE_DATA_LENGTH, 0);
        loader.addInstancedAtrribute(quad.getVaoID(), vbo, 2, 4, INSTANCE_DATA_LENGTH, 4);
        loader.addInstancedAtrribute(quad.getVaoID(), vbo, 3, 4, INSTANCE_DATA_LENGTH, 8);
        loader.addInstancedAtrribute(quad.getVaoID(), vbo, 4, 4, INSTANCE_DATA_LENGTH, 12);
        loader.addInstancedAtrribute(quad.getVaoID(), vbo, 5, 4, INSTANCE_DATA_LENGTH, 16);
        loader.addInstancedAtrribute(quad.getVaoID(), vbo, 6, 4, INSTANCE_DATA_LENGTH, 20);
    }
    ...
    protected void render(Map<ParticleTexture, List<Particle>> particles, Camera camera) {
        ...
        for (ParticleTexture texture : particles.keySet()) {
            ...
            _loader.updateVBO(vbo, vboData, BUFFER);
